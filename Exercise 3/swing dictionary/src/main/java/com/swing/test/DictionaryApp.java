...
import com.swing.views.AddWordDialog;
import com.swing.views.DeleteWordDialog;
import com.swing.views.FavoritesPanel;
...
//        statsButton.addActionListener(e -> showStatsPanel());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new DictionaryApp().setVisible(true));
    }
}
